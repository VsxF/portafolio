...
import { RadioCircle, RadioInput, RadioLabel, RadioPath, RadioSVG, RadioText } from "./style";

const Radio: FC<{ children: string | ReactNode, selected?: boolean }> = ({ children, selected }) => {
    return (
